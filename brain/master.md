...
## 19. Current status — 22 May 2026 PM-198 (Connect Elite hero shipped: lock-icon ring, 10-dot consecutive-day strip, Dexie-first paint, connect_checkins counts toward streak server-side parity)
