...
**PM-882 (2026-08-08):** portal Help tab live — 10-question FAQ (current-truth model, Lewis copy pass owed) + message-us form (partner-support EF v1, 5/day limit, logged to partner_support_messages then emailed to team@ reply-to-sender). team@ inbox is the support channel; CC inbox surface for the table = future.
