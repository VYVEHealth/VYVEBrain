...
**PM-875/876 (2026-08-07): partner money model SETTLED** — VYVE merchant of record for ALL payments (bookings move off partner payment links, 100% to partner minus Stripe fees for now); payout = finance-director invoice + bank transfer monthly (BACKLOGGED build; self-billing rec pending Lewis agreement wording). Shipped: send-a-nudge (partner-nudge EF v1 — PII-clean reach-out, 1/day/partner, 1/member/month), partner_bank_details capture in portal + CC readiness line (CC `222bdcea` + `aa6bdae5`), phantom "1 attributed sub" purged (7 June seed payout rows), runPayouts = referred+active+value>0 only. Lewis nudge-email copy pass gates Men Together provisioning.
