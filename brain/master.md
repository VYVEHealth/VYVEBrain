...
**Sequence after PM-39:** Ten Layer 1c migrations down (1c-1 through 1c-10), four to go (1c-11 → 1c-14). 71% complete by surface count. Remaining surfaces: shared-workout, monthly-checkin (likely `monthly_checkin:submitted` ADD), certificate / certificates (achievement-adjacent), and live-session pages. Then option-(b) cleanup commit closes Layer 1. Next session = PM-40, pre-flight at HEAD `1a5d9ef8` will pick the cleanest next 1c row.
