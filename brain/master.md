...
## 19. Current status — 23 May 2026 PM-212.2 (Podcast hub thumbnail fix — V-glyph fallback replaces logo.png+filter approach that wasn't rendering on device; Louis Watkins thumbnail NULLed via Supabase due to EXIF 90° rotation at source, falls back to V-glyph until Storage migration in v1.1)
