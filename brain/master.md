...
## 19. Current status — 23 May 2026 PM-228 (Settings restructure shipped — Profile/Coaching/Preferences/Habits/Connections/About, sub-page for sign-out/danger/GDPR, avatar pipeline live end-to-end including `members.avatar_url` + `member-avatars` Storage bucket)
