...
## 19. Current status — 23 May 2026 PM-236 + handoff (replays.html ?debug=1 diagnostic shipped; next session rebuilds Replays as section-rails with per-category pages — Dean's preferred design after iframe-stuck-on-most-recent UX issue with PM-235)
