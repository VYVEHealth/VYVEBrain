...
## 19. Current status — 23 May 2026 PM-230 (Settings bugfix — null-guards on dead setting-name/setting-email writes from PM-228 transformer; Reset app cache + HK Diagnostic removed from About per Dean) — Profile/Coaching/Preferences/Habits/Connections/About, sub-page for sign-out/danger/GDPR, avatar pipeline live end-to-end including `members.avatar_url` + `member-avatars` Storage bucket)
