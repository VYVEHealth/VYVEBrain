...
## 19. Current status — 23 May 2026 PM-212 (Podcast hub MVP shipped — podcast.html new page + Connect Podcast tile next to Calendar + Supabase podcast_episodes table seeded 40 rows + Dexie SCHEMA_V10 + sync.js plan entry. External-links MVP: Spotify/Apple/Amazon buttons per episode; in-app player deferred to post-trial v2)
