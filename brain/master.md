...
**PM-1006 (2026-09-04): CC design system Wave 0 LIVE (`c6a9fb49`) — tokens.css v3 + components.css v2 + shell slimmed to chrome + density boot. Spec = `tasks/cc-design-system-locked.md`. Waves 1-4 pending, one per session, Dean device check between each, dark theme first. `--fs-xxs`/`--fs-hero` are compat aliases due to retire in Wave 4.**
