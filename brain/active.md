...
0. **PF-40 — LOCAL-FIRST CONSOLIDATION CAMPAIGN (active meta-frame, supersedes per-page wire work).** 12 sub-items (PF-40.1 audit through PF-40.12 cleanup), ~13-16 Claude-assisted sessions total. PF-40.1 audit is the next ship (read-only, solo daytime, no device). PF-14d, PF-14e, PF-15.write-optimistic, PF-31, PF-32, PF-33, PF-34 partial, PF-34b, PF-35, PF-36 all fold into PF-40 as symptoms. PF-14b stays separate. See `tasks/backlog.md` PF-40 section for full sub-item list + dependency graph + device-requirement table.
