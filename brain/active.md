...
**Last verified:** 13 May 2026 PM-90 (PF-30 SHIPPED — local-first telemetry redirect; perf.js v3 + PostHog session replay + dexie/perf events). PM-78 shipped PF-1/2/3; PM-79 shipped PF-4/5; build chat shipped PF-6 (commit `48c4d17e`), PF-7 (commit `97863198`), PF-8 (commit `d2fc1e89`), PF-9 (commit `197a0d89`), PF-10 (commit `9813e800`), PF-11a (commit `8b79c54d`), PF-11b (commit `a248bfef`), and PF-30 (commit `707aa3af`) directly to `local-first-spike`. PM-83/84/85 are scope-chat brain-only writes for PF-13/PF-24/PF-25/PF-30 — no build state change at the time. PM-86 = PF-9 brain restore, PM-86.1 = base64 double-encoding repair (see §23 candidate). PM-88 split PF-11; PM-89 completed it; PM-90 ships PF-30.

| What | Value |
|---|---|
| vyve-site main HEAD | `ff3e0e0f` (PM-76 perf.js v2 promotion — unchanged; PF-1/2/3 on feature branch only) |
| vyve-site `local-first-spike` HEAD | `707aa3af` (PF-1 through PF-11 + PF-30 — Dexie schema + hydrate + shadow outbound queue + since-cursor delta-pull + habits + workouts + nutrition + cardio + wellbeing-checkin + monthly-checkin Dexie-first reads + index.html full Dexie-derived dashboard via home-state-local.js + perf.js v3 telemetry redirect + PostHog session replay at 100%; spike gated by `localStorage.vyve_lf_spike`; 13 commits ahead of `main`) |
| VYVEBrain main HEAD | this commit (PM-90 — PF-30 ship narrative; active.md + campaign.md advanced to PF-30 SHIPPED state; perf.js v3 + posthog session replay + new dexie/perf events) |
| SW cache key (production) | `vyve-cache-v2026-05-12-pm76-perf-promote-a` (unchanged; spike branch cache key is `vyve-cache-v2026-05-13-pm90-pf30-telem-a`) |
...
| Last shipped vyve-site commits | main unchanged: `fc8232bb` (PM-74), `5cef00a2` (PM-75), `ff3e0e0f` (PM-76). Spike branch: `8d07d26b` (PF-1), `e8f02742` (PF-2/3), `903127d6` (PF-4), `fa116ef2` (PF-5), `48c4d17e` (PF-6), `97863198` (PF-7), `d2fc1e89` (PF-8), `197a0d89` (PF-9), `9813e800` (PF-10), `8b79c54d` (PF-11a), `a248bfef` (PF-11b), `707aa3af` (PF-30). |
