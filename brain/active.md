...
| What | Value |
|---|---|
| vyve-site main HEAD | `ddc13271` (PM-97 PF-15 P0 — partial-upsert merge fix + recovery gesture). Earlier tonight: `433d0650` exercise.html Dexie wiring; `4ffe3d72` diagnostic ship; `67711c4e` PF-14 part 6 hydrate-await; `a3c74734` PF-14 part 4 habits-cache; spike merge `c469e504`. Spike branch still redundant, slated for PF-19 cleanup deletion. |
...
| SW cache key (production) | `vyve-cache-v2026-05-13-pm97-pf15-merge-upsert-a` (PM-97 PF-15 P0 — partial-upsert merge override on member_habits + members + recovery long-press gesture. Bumped through pm96-pf15-diag-a + pm96-pf15-exercise-dexie-a earlier this evening.) |
