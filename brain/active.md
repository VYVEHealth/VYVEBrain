...
**Last verified:** 13 May 2026 PM-93 (verification-mode audit — brain drift caught + repaired; PF-12 + PF-13 scaffolding SHIPPED narratives spliced in). PM-78 shipped PF-1/2/3; PM-79 shipped PF-4/5; build chat shipped PF-6 (commit `48c4d17e`), PF-7 (commit `97863198`), PF-8 (commit `d2fc1e89`), PF-9 (commit `197a0d89`), PF-10 (commit `9813e800`), PF-11a (commit `8b79c54d`), PF-11b (commit `a248bfef`), PF-30 (commit `707aa3af`), PF-12 (commit `302087de`, PM-91), and PF-13 scaffolding (commit `11abad83`, PM-92) directly to `local-first-spike`. PM-83/84/85 are scope-chat brain-only writes for PF-13/PF-24/PF-25/PF-30 — no build state change at the time. PM-86 = PF-9 brain restore, PM-86.1 = base64 double-encoding repair (see §23 candidate). PM-88 split PF-11; PM-89 completed it; PM-90 shipped PF-30; PM-91 shipped PF-12; PM-92 shipped PF-13 scaffolding (copy gate pending Dean); PM-93 = this audit repair.

| What | Value |
|---|---|
| vyve-site main HEAD | `ff3e0e0f` (PM-76 perf.js v2 promotion — unchanged; PF-1/2/3 on feature branch only) |
| vyve-site `local-first-spike` HEAD | `11abad83` (PF-1 through PF-13 scaffolding — Dexie schema + hydrate + shadow outbound queue + since-cursor delta-pull + habits + workouts + nutrition + cardio + wellbeing-checkin + monthly-checkin Dexie-first reads + index.html full Dexie-derived dashboard via home-state-local.js + perf.js v3 telemetry redirect + PostHog session replay at 100% + settings.html Dexie-first + hydration.js persona welcome scaffolding awaiting Dean copy gate; spike gated by `localStorage.vyve_lf_spike`; 15 commits ahead of `main`) |
...
| SW cache key (production) | `vyve-cache-v2026-05-12-pm76-perf-promote-a` (unchanged; spike branch cache key is `vyve-cache-v2026-05-13-pm92-pf13-hydration-a`) |
...
2.11f. **PF-14 through PF-20** — Capacitor device verification + hardening + nav restructure + merge to main. Sequenced in playbook.
