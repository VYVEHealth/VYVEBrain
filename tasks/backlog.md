> **[SPRINT WINDOW: Dean wants a HUGE dent in the coaching platform before his usage reset THURSDAY 3 Sep — sessions resume Tue 2 Sep. Order of attack: gate → apply pipeline → trial-wall £10 routing → workout summaries → check-in bucket → Calum provisioning; messaging/automations only if the core lands early.]**
