> **[2026-09-04 · PM-991 PARTNER PORTAL OVERHAUL — W1-W4 SHIPPED, W5-W6 remain]** Method = PM-982 redux, benchmark our own coach portal; map at `tasks/partner-portal-gap-map.md`. W1 ✅ PM-991 (CC `ba038b87`) · W2 ✅ PM-992 (CC `bf83f48d`) · W2b ✅ PM-993 (CC `2f9fca6a` — Go Live gated on 7 profile checks + approved welcome video, advisory first-content/bank, kanban path covered, PM-880 posture untouched) · W3 ✅ PM-994 (CC `5a012fcb` — calendar month/week/list over occurrences+bookings, badge-counted requests inbox riding booking-paid-confirm, content library lanes/folders/stats; content_folders jsonb migration, partner-content-upload v11, partner-notify v2 self-notify fix) · W4 ✅ PM-995 (CC `cf235032` — self-billing statements w/ print-to-PDF, £25 rollover as payment discipline, human promo codes Piece 1 COMPLETE incl. app-signup v8 code-or-slug + 17/17 backfill, CC payable rollup; funnel + CC payout run found already shipped — gap-map lag). REMAINING: **W5** reach (leads generalised beyond coaches, ratings list surface, community engagement stats, Checkout Session Piece 2, CC manual attribution Piece 5) · **W6** wizard at-source (photos→thumbnails + cropper port, honest upload errors, wizard reportError) + partners.vyvehealth.co.uk + PORTAL_BRAND_URL + one-shot EF deletions. **Lewis owes (W4, non-gating):** statement copy pass [LEWIS COPY PASS], self-billing agreement clause + VAT position (statement stays statement-not-invoice until confirmed). **Dean device passes owed (accumulated W1→W4):** W1 tiles/routing/notifs · W2 Account tabs/prefs/password · W2b CC minimums panel + disabled Go Live · W3 calendar/requests/lanes/folders + v11 authed content list w/ stats · W4 statement modal+print, rollover states, ALEX10 in share copy, CC Revenue rollup.
