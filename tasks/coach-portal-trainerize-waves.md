...
## W9 — Client workspace depth (2 sessions) — **PART 1 SHIPPED PM-1112/1113 (#101, #105, #108; #106 dark behind `W9_HEALTH_VISIBLE`). PART 2 SHIPPED PM-1125/1126 (#107, #109, per-habit heatmap, #91). **W9 COMPLETE.** #106 remains dark behind `W9_HEALTH_VISIBLE`, waiting only on Lewis’s consent wording.** (PM-1121 briefly added recipe search + filter here; PM-1124 removed it — that belongs to the W7 / nutrition workstream, not W9.)
