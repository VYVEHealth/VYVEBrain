...
| C6 | Email tenant (finding U) | **RE-RATED 9 Sep 2026 — not just special-category data on consumer hosting: the shared Google account fronts the whole estate via Sign-in-with-Google, and a consumer account has NO administrative recovery. Highest-value security + continuity item.** | ~£12/user/mo | 1 week | **Yes** | **Yes** |
